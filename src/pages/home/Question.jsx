...
export default function Question() {
	...
	return (
		<FeedContainer>
			<WaitWrap>
				<TimerIcon style={{ width: '60px', height: '3.75rem' }}></TimerIcon>
				<SubText fontsize="1rem" margin="1rem 0 0.5rem 0">
					질문하기는 아직 준비중이에요
				</SubText>
				<SubText fontsize="0.875rem" color="#8d8d8d" fontweight="normal">
					조금만 기다려 주세요!
				</SubText>
			</WaitWrap>
		</FeedContainer>
