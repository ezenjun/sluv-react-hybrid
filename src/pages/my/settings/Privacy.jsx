		...
		<MainContainer>
			...
			<ContentWrap padding="1rem 1.25rem 1rem 1.25rem">
				...
				<ContentParagraphWrap>
					...
					<p>○ 이 개인정보처리방침은 2022년 7월 18일 부터 적용됩니다.</p>
					<p>&nbsp;</p>
					<p>제1조(개인정보의 처리 목적)</p>
					<p>
					...
					<p>② &lt;스럽&gt;은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.</p>
					<p>1. &lt;현재 해당 사항 없음&gt;</p>
					...
					<p>위탁기간 :</p>
					<p>
						② &lt;스럽&gt;은(는) 위탁계약 체결시 「개인정보 보호법」 제26조에 따라
					...
					<p>
						① 정보주체는 &lt;스럽&gt;에 대해 언제든지 개인정보
						열람&middot;정정&middot;삭제&middot;처리정지 요구 등의 권리를 행사할 수
						있습니다.
					</p>
					<p>
						② 제1항에 따른 권리 행사는 &lt;스럽&gt;에 대해 「개인정보 보호법」 시행령
					...
					<p>① &lt;스럽&gt;은(는) 다음의 개인정보 항목을 처리하고 있습니다.</p>
					<p>1&lt; 홈페이지 회원가입 및 관리 &gt;</p>
					<p>필수항목 : 휴대전화번호, 이메일, 비밀번호, 닉네임</p>
					<p>선택항목 :</p>
					...
					<p>
						② 정보주체께서는 &lt;스럽&gt;의 서비스(또는 사업)을 이용하시면서 발생한 모든
